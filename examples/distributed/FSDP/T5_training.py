...
def fsdp_main(args):
    ...
    if rank==0:
        ...
        print(f"train accuracy {train_acc_tracking} and validation accuracy {val_acc_tracking}")
        print(f"train time per epoch is {(training_end_time-training_start_time/ args.epochs)}")
